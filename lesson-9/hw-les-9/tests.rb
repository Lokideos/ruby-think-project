...
class Tests
  ...
  #   puts "Currently there are several trains on the " \
  #   "#{station1.name}: #{trains_on_station}"
  ...
  #   puts route1.stations
  #   unless
  #     [stations_on_route.first, stations_on_route.last].include? station3.name
  #     stations_on_route.delete(station3.name)
  #   end
  #   puts "Currently there are #{stations_on_route} on the #{route1.name}"
  ...
  #   s1.trains_on_station_handler do
  #    |param| puts "This is another block: #{param}"
  #   end
  # end
end
